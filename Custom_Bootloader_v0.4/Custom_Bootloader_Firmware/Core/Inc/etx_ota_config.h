...
/**@file
 * @brief	ETX OTA Protocol default configuration file for Bootloader Firmwares.
 *
 ...
 * @{
 *
 * @brief	This file contains all the Default User-Configurable settings for the @ref bl_side_etx_ota .
 *
...
#define ETX_OTA_VERBOSE 			        (0U)   	        	/**< @brief Flag value used to enable the compiler to take into account the code of both the @ref bl_side_etx_ota and the @ref firmware_update_config libraries that displays detailed information about the processes made inside them via @ref printf with a \c 1 . Otherwise, a \c 0 for not displaying any messages at all with @ref printf . */
#endif
