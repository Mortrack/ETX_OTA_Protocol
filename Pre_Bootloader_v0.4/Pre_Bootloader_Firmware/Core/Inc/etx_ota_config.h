...
/**@file
 * @brief	ETX OTA Protocol default configuration file for Pre-Bootloader Firmwares.
 *
...
#define ENABLE_APP_ETX_OTA_CONFIG           (0U)          		/**< @brief Flag used to enable the use of @ref app_etx_ota_config with a 1 or, otherwise to disable it with a 0. */
